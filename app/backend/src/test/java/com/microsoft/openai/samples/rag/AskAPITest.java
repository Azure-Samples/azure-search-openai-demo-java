...
class AskAPITest {
    ...
    */
    ...
    private SearchPagedIterable buildSearchPagedIterableWithDocs() {
        ...
        return new SearchPagedIterable(utils.getSearchPagedFlux(1, (inputInteger) -> List.of(cit1SearchResult, cit2SearchResult)));
    }
    ...
    private CompletionsOptions buildCompletionsOptionsWithMockData() {
        CompletionsOptions completionsOptions = new CompletionsOptions(new ArrayList<>(Arrays.asList(PROMPT_WITH_MOCKED_SOURCES)));
