...
class RAGApproachFactorySpringBootImplTest {
    ...
    void testCreateApproachWithInvalidApproachName() {
        assertThrows(IllegalArgumentException.class, () -> ragApproachFactory.createApproach("invalid", RAGType.ASK,null));
    }

    @Test
    void testCreateApproachWithInvalidCombination() {
        assertThrows(IllegalArgumentException.class, () -> ragApproachFactory.createApproach("rtr", RAGType.CHAT,null));
    }
