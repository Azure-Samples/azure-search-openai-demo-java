...
/**
 * This class is a proxy to the Blob storage API.
...
public class BlobStorageProxy {
    ...
    public BlobStorageProxy(@Value("${storage-account.service}") String storageAccountServiceName,
    ...
    public byte[] getFileAsBytes(String fileName) throws IOException {
        ...
        // There is no need to close ByteArrayOutputStream. https://docs.oracle.com/javase/8/docs/api/java/io/ByteArrayOutputStream.html
