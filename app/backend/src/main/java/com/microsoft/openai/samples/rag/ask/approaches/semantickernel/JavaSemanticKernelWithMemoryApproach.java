...
public class JavaSemanticKernelWithMemoryApproach implements RAGApproach<String, RAGResponse> {
    private static final Logger LOGGER = LoggerFactory.getLogger(JavaSemanticKernelWithMemoryApproach.class);
    ...
    public JavaSemanticKernelWithMemoryApproach(TokenCredential tokenCredential, OpenAIAsyncClient openAIAsyncClient, SearchAsyncClient searchAsyncClient) {
