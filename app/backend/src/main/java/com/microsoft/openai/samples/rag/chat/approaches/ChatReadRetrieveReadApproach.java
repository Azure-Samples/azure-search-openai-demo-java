...
public class ChatReadRetrieveReadApproach implements RAGApproach<ChatGPTConversation, RAGResponse> {
    ...
    public RAGResponse run(ChatGPTConversation questionOrConversation, RAGOptions options) {
        ...
        var cognitiveSearchQueryPrompt = new CognitiveSearchQueryPrompt(questionOrConversation);
        ...
        LOGGER.info("Total {} sources found in cognitive search for keyword search query[{}]", sources.size(), optimizedQuestion);
