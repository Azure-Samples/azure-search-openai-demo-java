...
The chat tab uses the approach programmed in [ChatReadRetrieveReadApproach.java](https://github.com/Azure-Samples/azure-search-openai-demo-java/blob/main/app/backend/src/main/java/com/microsoft/openai/samples/rag/chat/approaches/ChatReadRetrieveReadApproach.java).
...
The ask tab uses the approach programmed in [PlainJavaAskApproach.java](https://github.com/Azure-Samples/azure-search-openai-demo-java/blob/main/app/backend/src/main/java/com/microsoft/openai/samples/rag/ask/approaches/PlainJavaAskApproach.java).
...
There are also two other /ask approaches which are implemented using **Java Semantic Kernel** sdk. One implementation is available in [JavaSemanticKernelAskApproach](https://github.com/Azure-Samples/azure-search-openai-demo-java/blob/main/app/backend/src/main/java/com/microsoft/openai/samples/rag/ask/approaches/semantickernel/JavaSemanticKernelAskApproach.java) and it's still experimental. It will be consolidated as soon as semantic kernel beta version will be released.
</details>
